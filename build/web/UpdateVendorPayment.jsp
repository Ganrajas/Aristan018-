...
<%
    ...
    try{
        ...
        String sql="select * from vendor where VPID="+id;
        ...
        <form name="f1" method="post" action="Update_Process_Vendor.jsp" autocomplete="off">
   <table cellpadding="5" align="center">
       
        <input type="hidden" name="VPID" value="<%=rs.getString("VPID")%>" class="inputclass"><br>
        
    <tr>
      <th colspan="2">
        <h2> Update Vendor Entry</h2>
      </th>
    </tr>
    
    <tr>
      <td> Vendor Payment Date </td>
      <td> <input type="date" name="vdate" class="inputclass" value="<%=rs.getString("VPDATE")%>"></td>
    </tr>
    ...
    <tr>
      ...
      <td> 
          <input type="text" name="vcomp" class=" inputclass" value="<%=rs.getString("VCOMP")%>">
      </td>
    </tr>
    ...
    <tr>
      <td> Pay By </td>
      <td> <input type="text" name="pby" class=" inputclass" value="<%=rs.getString("PAYBY")%>"></td>
    </tr>
