...
<html>
    ...
    <body>
    <center>
        <h2> C & CPP Enquiry Entry Details </h2>
...
<%
    try{
        ...
        String sql="select * from enquiry where modular='C Programming CPP Programming' or modular='C Programming' or modular='CPP Programming' or modular='CPP Programming C Programming' order by EID";
