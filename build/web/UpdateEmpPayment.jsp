...
<%
    ...
    try{
        ...
        String sql="select * from emppayentry where PAYID="+id;
        ...
        <form name="f1" method="post" action="Update_Process_EmpPayEntry.jsp" autocomplete="off">
   <table cellpadding="5" align="center">
       
        <input type="hidden" name="PAYID" value="<%=rs.getString("PAYID")%>" class="inputclass"><br>
        
    <tr>
      <th colspan="2">
        <h2> Update Employee Payment Entry</h2>
      </th>
    </tr>
    
    <tr>
      <td> P-date </td>
      <td> <input type="date" name="pdate" class="inputclass" value="<%=rs.getString("PDATE")%>"></td>
    </tr>
    ...
    <tr>
      <td> Job </td>
      <td> 
          <input type="text" name="job" class=" inputclass" value="<%=rs.getString("JOB")%>">
      </td>
    </tr>
