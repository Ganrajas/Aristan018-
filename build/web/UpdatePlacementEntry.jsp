...
<%
    ...
    try{
        ...
        <form name="f1" method="post" action="Update_Process_PlacementEntry.jsp" autocomplete="off">
   <table cellpadding="5" align="center">
    ...
    <tr>
      <th colspan="4">
        <h2> Update Client Entry</h2>
      </th>
    </tr>
    
     <tr>
      <td>Company Name </td>
      <td> <input type="text" name="comp_name" class="inputclass" value="<%=rs.getString("COMPANY_NAME")%>"></td>
    
      <td> Company URL </td>
      <td> <input type="text" name="comp_URL" class=" inputclass" value="<%=rs.getString("COMPANY_URL")%>"></td>
    </tr>
    ...
    <tr>
      <td> Contact No </td>
      <td> <input type="text" name="contactno" class=" inputclass" value="<%=rs.getString("CONTACT_NO")%>"></td>
    
      <td> Email Id </td>
      <td> <input type="text" name="email" class=" inputclass" value="<%=rs.getString("EMAIL_ID")%>"></td>
    </tr>
    ...
    <tr>
      ...
      <td> 
          <input type="text" name="tech_require" class=" inputclass" value="<%=rs.getString("TECH_REQUIREMENT")%>">
      </td>
    
      <td> Require Status </td>
      <td> 
          <input type="text" name="require_time" class=" inputclass" value="<%=rs.getString("REQUIRE_STATUS")%>">
      </td>
    </tr>
     ...
     <tr>
      <td> Show Date </td>
      <td> 
          <input type="date" name="select_date" class=" inputclass" value="<%=rs.getString("SHOW_DATE")%>">
      </td>
