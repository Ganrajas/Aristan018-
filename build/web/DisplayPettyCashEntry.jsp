...
<html>
    ...
    <body>
        <div id="brandname">
         <h1> Aristan CRM- Petty Cash Enquiry Details </h1>
    ...
    try{
        ...
        while(rs.next())
        {
            ...
            <tr>
                ...
                <td> <%=rs.getString("PURCHASE_DETAIL")%> </td>
                <td> <%=rs.getString("PURCHASE_QTY")%> </td>
                <td> <%=rs.getString("PURCHASE_RATE")%> </td>
                <td>&#8377; <%=rs.getString("BILL_AMT")%> </td>
                <td> <%=rs.getString("PURCHASE_BY")%> </td>
                 <td> <%=rs.getString("APPROVAL_BY")%> </td>
               
                
                <td><a href="DeletePettyCash.jsp?id=<%=rs.getString("PCASHID")%>">
                    <span class="glyphicon glyphicon-trash" onclick="return confirm('Do you want  to delete the record ? ')"></span></a></td>
               
               <td><a href="UpdatePettyCash.jsp?id=<%=rs.getString("PCASHID")%>">
