...
<html>
    ...
    <table border="1" align="center">
        <tr bgcolor="deeppink"> 
            ...
            <th>Email</th>
            <th>PHONE NO</th>
            <th>Installment Date1</th>
            <th>Installment Date2</th>
            <th>Installment Date3</th>
            <th>Installment Amount1</th>
            <th>Installment Amount2</th>
            <th>Installment Amount3</th> 
             <th>FEES STATUS-1</th>
            <th>FEES STATUS-2</th>
            <th>FEES STATUS-3</th>
            <th>Check Status</th>
    ...
    try{
        ...
        while(rs.next())
        {
            ...
            <tr>                
                ...
                {
                  %>
                   <td bgcolor='limegreen'> <%=rs.getString("feesstatus1")%> </td>
               <%    
                }
                else
                {
                %>
                    <td bgcolor='gold'> <%=rs.getString("feesstatus1")%> </td> 
                <%    
                }
                %>
...
<!--                 code for installment-2-->
                ...
                {
                  %>
                   <td bgcolor='limegreen'> <%=rs.getString("feesstatus2")%> </td>
               <%    
                }
                else
                {
                %>
                    <td bgcolor='gold'> <%=rs.getString("feesstatus2")%> </td> 
                <%    
                }
                %>
...
<!--                 code for installment-3-->
                ...
                {
                  %>
                   <td bgcolor='limegreen'> <%=rs.getString("feesstatus3")%> </td>
               <%    
                }
                else
                {
                %>
                    <td bgcolor='gold'> <%=rs.getString("feesstatus3")%> </td> 
                <%    
                }
                %> 
