...
<%
    try{
        ...
        String sql="select * from  cliententry order by CLIENT_ID desc";
        ...
        while(rs.next())
        {
            ...
            <tr>
                ...
                <td> <%=rs.getString("NATURE_BUSSINESS")%> </td>
                <td> <%=rs.getString("PHONENO")%> </td>
                <td> <%=rs.getString("EMAIL")%> </td>
                 <td> <%=rs.getString("ADDRESS")%> </td>
               
                
                <td><a href="DeleteClientEntry.jsp?id=<%=rs.getString("CLIENT_ID")%>">
                     <span class="glyphicon glyphicon-trash" onclick="return confirm('Do you want  to delete the record ? ')"></span></a></td>
               
               <td><a href="UpdateClientEntry.jsp?id=<%=rs.getString("CLIENT_ID")%>">
