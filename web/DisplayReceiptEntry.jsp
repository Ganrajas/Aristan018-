...
<html>
    ...
    <body>
        <div id="brandname">
         <h1> Aristan CRM - Receipt Entry Details </h1>
...
<%
    try{
        ...
        String sql="select * from  receipt order by RID desc";
