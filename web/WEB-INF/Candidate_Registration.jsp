...
<%
    ...
    String phoneno=request.getParameter("phoneno");
     ...
     try{
        ...
        String sql="insert into candidate(FIRST_NAME,LAST_NAME,EMAIL,PHONENO,BRANCH,GENDER,TECHNOLOGY,FEES,IDATE1,IDATE2,IDATE3,IAMT1,IAMT2,IAMT3)values('"+fname+"','"+lname+"','"+email+"','"+phoneno+"','"+branch+"','"+gen+"','"+tech+"','"+fees+"','"+idate1+"','"+idate2+"','"+idate3+"','"+iamt1+"','"+iamt2+"','"+iamt3+"')";
        int i= st.executeUpdate(sql);
        
        
        out.println(" Candidate Registration Done Successfully.....!");
