...
<%
    ...
    <tr>         
      <td> Select Course</td>
      <td colspan="3"> 
          <input type="radio" name="toc" value="Modular" onclick="show_mod_fun()" <%=rs.getString("modular").equals("modular")?"checked":"unchecked"%> onclick="show_mod_fun()">Modular Technology
          <input type="radio" name="toc" value="Internship" onclick="show_intern_fun()"<%=rs.getString("intern").equals("intern")?"checked":"unchecked"%> onclick="show_intern_fun()">Internship Technology
          <input type="radio" name="toc" value="Job Oriented" onclick="show_job_fun()"<%=rs.getString("job").equals("job")?"checked":"unchecked"%> onclick="show_job_fun()">Job Oriented Technology
      </td>
    </tr>
    ...
    <td colspan="3">
       <input type="checkbox" name="tech" value="C Programming"  onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("C Programming")?"checked":"unchecked"%>>C Programming
       <input type="checkbox" name="tech" value="CPP Programming" onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("CPP Programming")?"checked":"unchecked"%>>CPP Programming
       <input type="checkbox" name="tech" value="Core Java" onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("Core Java")?"checked":"unchecked"%>>Core Java 
        <input type="checkbox" name="tech" value="Python" onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("Python")?"checked":"unchecked"%>>Python
        <input type="checkbox" name="tech" value="PHP" onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("PHP")?"checked":"unchecked"%>>PHP
        <input type="checkbox" name="tech" value="Javascript" onclick="show_tcost_for_all_checkbox()" <%=rs.getString("STECH").equals("Javascript")?"checked":"unchecked"%>>JavaScript
    </td>
    </tr>
    ...
    <td colspan="3">
        <input type="radio" name="tech" value="Java Internship" onclick="show_tcost_for_intern_radio_button()" <%=rs.getString("STECH").equals("Java Internship")?"checked":"unchecked"%>>Java Internship
        <input type="radio" name="tech" value="Python Internship" onclick="show_tcost_for_intern_radio_button()" <%=rs.getString("STECH").equals("Python Internship")?"checked":"unchecked"%>>Python Internship
        <input type="radio" name="tech" value="PHP Internship" onclick="show_tcost_for_intern_radio_button()" <%=rs.getString("STECH").equals("PHP Internship")?"checked":"unchecked"%>>PHP Internship
        <input type="radio" name="tech" value="Web Internship" onclick="show_tcost_for_intern_radio_button()" <%=rs.getString("STECH").equals("Web Internship")?"checked":"unchecked"%>>Web Internship
    </td>
    </tr>
    ...
    <td colspan="3">
        <input type="radio" name="tech" value="Java FSD" onclick="show_tcost_for_job_radio_button()" <%=rs.getString("STECH").equals("Java FSD")?"checked":"unchecked"%>>Java FSD
        <input type="radio" name="tech" value="Python FSD" onclick="show_tcost_for_job_radio_button()" <%=rs.getString("STECH").equals("Python FSD")?"checked":"unchecked"%>>Python FSD
        <input type="radio" name="tech" value="PHP FSD" onclick="show_tcost_for_job_radio_button()" <%=rs.getString("STECH").equals("PHP FSD")?"checked":"unchecked"%>>PHP FSD
        <input type="radio" name="tech" value="Web FSD" onclick="show_tcost_for_job_radio_button()" <%=rs.getString("STECH").equals("Web FSD")?"checked":"unchecked"%>>Web FSD
    </td>
    </tr>
